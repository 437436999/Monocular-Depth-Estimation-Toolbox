...
data = dict(
    ...
    train=dict(
        ...
        data_root=data_root,
        depth_scale=10000,
        split='2000C_trainW_rect_v2_refine.txt',
    ...
    val=dict(
        ...
        data_root=data_root,
        depth_scale=10000,
        split='2000C_testW_rect_refine.txt',
...
# runtime settings
runner = dict(type='IterBasedRunner', max_iters=1600 * 80)
checkpoint_config = dict(by_epoch=False, max_keep_ckpts=100, interval=3200)
